...
namespace TetrTW
{
    public partial class Form6 : Form
    {
        ...
        public Form6(string value1, string value2)
        {
            InitializeComponent();
            log = value1;
            mode = value2;
        ...
        void full_line_check()
        {
            ...
            else if (clear_line % 4 == 2)
            {
                score += 10;
                label_score.Text = score.ToString();
            }
            else if (clear_line % 4 == 3)
            {
                score += 20;
                label_score.Text = score.ToString();
            }
            else if (clear_line % 4 == 0 && clear_line != 0)
            {
                score += 40;
                label_score.Text = score.ToString();
            }
            ...
            // clear_line = 40;
            label_line.Text = "TotalLine：" + Convert.ToString(clear_line);
            if (clear_line == 40)
            {
                for (int k = 0; k <= 4; k++)
                {
                ...
                StreamWriter strWrite = new StreamWriter("LogFile/Mode3.txt");
                if (rank_count < 10)
                {
                    rank_count += 2;
                    strWrite.WriteLine(Convert.ToString(rank_count));
                    for (int k = 0; k < (rank_count - 2) / 2; k++)
                    {
                        if (k == idx)
                        {
                        ...
                        strWrite.WriteLine(all_rank_name[k]);
                        strWrite.WriteLine(all_rank[k]);
                    }
                    if (idx == 666)
                    {
                        strWrite.WriteLine(Player_Name.Text);
                ...
                re_score.Text = Convert.ToString(score) + " / " + duration + "s";
                return;
            }
        }
        ...
        private void Form6_Load(object sender, EventArgs e)
        {
            ...
            // label3.Top = label2.Top + label2.Height + 25;
            ...
            // 排行榜
            StreamReader strRank = new StreamReader("LogFile/Mode3.txt");
            ...
            for (int i = 1; i <= rank_count / 2; i++)
            {
                ...
                Ranks[i - 1].Width = 355;
                Ranks[i - 1].Height = 40;
                Ranks[i - 1].Text = name_tmp + "  " + score_tmp + " s";
                Ranks[i - 1].Left = 0;
                if (i == 1)
                {
                    Ranks[i - 1].Top = 0;
        ...
        {
            duration++;
            label_times.Text = (duration / 60).ToString() + "：" + (duration % 60).ToString();
