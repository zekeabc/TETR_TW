...
namespace TetrTW
{
    public partial class Form5 : Form
    {
        ...
        public Form5(string value1, string value2)
        {
            InitializeComponent();
            log = value1;
            mode = value2;
        ...
        private void Form5_Load(object sender, EventArgs e)
        {
            ...
            // 排行榜
            StreamReader strRank = new StreamReader("LogFile/Mode2.txt");
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (block_row == 20)
                {
                    ...
                    StreamWriter strWrite = new StreamWriter("LogFile/Mode2.txt");
                    if (rank_count < 10)
                    {
                        rank_count += 2;
